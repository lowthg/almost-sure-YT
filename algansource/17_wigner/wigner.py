...
from algansource.wave import setup_wave, set_wave, setup_cam, setup_surf, WaveEvolution
...
def dynamics_simple(quality=LD, bgcol=BLACK, anim=1, just_wave=False):
    ...
    evolver = WaveEvolution(n_extend_right=n_extend_right, n_extend_left=n_extend_left, speed=speed, just_wave=just_wave, col_psi=col_psi)
    evolver.create_wave()
...
if __name__ == "__main__":
    ...
    wigner_anim(quality=LD, bgcol=BLACK, anim=1, show_wave=True)
    # for anim in [13]:
